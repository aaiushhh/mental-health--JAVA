...
class DatabaseConnector {
    ...
    private static final String PASSWORD = "meow99";
...
class Main {
    public static void main(String[] args) throws SQLException {
        try (Scanner sc = new Scanner(System.in);
            ...
            Service obj;
            int startPageSelection, flag = 1, check;
                ...
                switch (startPageSelection) {
                    case 1:
                        ...
                        try (PreparedStatement loginStatement = connection.prepareStatement(query)) {
                            ...
                            if (check == 1) {
                                ...
                                try (PreparedStatement selectUserStatement = connection.prepareStatement(query)) {
                                    selectUserStatement.setString(1, username);
                                    ResultSet userResultSet = selectUserStatement.executeQuery();
                                    obj = new Service(userResultSet.getString("Name"), userResultSet.getInt("Age"),
                                            userResultSet.getString("Gender"), userResultSet.getString("Occupation"),
                                            userResultSet.getInt("Anxiety"), userResultSet.getInt("Ocd"),
                                            userResultSet.getInt("Schiz"), userResultSet.getInt("Bipolar"),
                                ...
                                if (fp == 'y') {
                                    ...
                                    try (PreparedStatement forgotPasswordStatement = connection
                                        ...
                                        ResultSet forgotPasswordResultSet = forgotPasswordStatement.executeQuery();
                                        if (resultSet.next()) {
                                            check = resultSet.getInt("1");
                                        } else {
                                            check = 0;
                                        ...
                                        if (check == 1) {
                                            ...
                                            try (PreparedStatement contactCheckStatement = connection
                                                ...
                                                ResultSet contactCheckResultSet = contactCheckStatement.executeQuery();
                                                if (resultSet.next()) {
                                                    check = resultSet.getInt("1");
                                                } else {
                                                    check = 0;
                                                ...
                                                if (check == 1) {
                                                    ...
                                                    try (PreparedStatement getPasswordStatement = connection
                                                        ...
                                                        ResultSet passwordResultSet = getPasswordStatement
                                                                .executeQuery();
                    ...
                    case 2:
                        ...
                        if (flag == 1) {
                            ...
                            password = sc.nextLine();
                            query = "insert into mentalHealthDatabase(Name, Password) values (" + username + ","
                                    + password
                                    + ")";
